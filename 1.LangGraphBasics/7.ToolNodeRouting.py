...
builder.add_node("tools",ToolNode(tools_))
...
#tool calling✅
y=graph_builder.invoke({"messages":"5-2"})
for x in y["messages"]:
    print(x.pretty_print())


#without tool call
z=graph_builder.invoke({"messages":"tell me about linear regression"})
for zx in z["messages"]:
    print(zx.pretty_print())
